-- Creación de la base de datos compatible con MariaDB/XAMPP
...
CREATE TABLE `paises` (
  ...
  `miembroUE` tinyint(1) NOT NULL, -- Cambiado de BIT a TINYINT para mejor manejo en Python/Pandas
...
-- ------------------------------------------------------
-- Estructura para la tabla `fronteras`
-- ------------------------------------------------------
...
-- ------------------------------------------------------
-- Estructura para la tabla `temperaturas`
-- ------------------------------------------------------
