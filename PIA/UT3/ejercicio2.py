...
# ============================================
# EJERCICIO 1: PAÍSES CON EURO
# ============================================
print("1. Obteniendo países con Euro...")
...
# ============================================
# EJERCICIO 2: PAÍSES CON DÓLAR
# ============================================
print("\n2. Obteniendo países con Dólar...")
paises_dolar = []
for pais in paises:
    if 'currencies' in pais:
        for codigo, moneda in pais['currencies'].items():
...
# ============================================
# EJERCICIO 3: PAÍSES QUE HABLAN ESPAÑOL
# ============================================
print("\n3. Obteniendo países hispanohablantes...")
response = requests.get(f"{BASE_URL}/lang/spa")
paises_espanol = response.json()
guardar_json(paises_espanol, 'paises_espanol.json')

# ============================================
# EJERCICIO 4: PAÍSES DEL CARIBE
# ============================================
print("\n4. Obteniendo países del Caribe...")
...
# ============================================
# EJERCICIO 5: PAÍSES DE EUROPA
# ============================================
print("\n5. Obteniendo países de Europa...")
response = requests.get(f"{BASE_URL}/region/europe")
paises_europa = response.json()
guardar_json(paises_europa, 'paises_europa.json')

# ============================================
# EJERCICIO 6: AMÉRICA (RESUMEN)
# ============================================
print("\n6. Obteniendo resumen países de América...")
